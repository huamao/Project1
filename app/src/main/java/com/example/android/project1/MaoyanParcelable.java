...
public class MaoyanParcelable implements Parcelable {
    ...
    public MaoyanParcelable(String maoyan_id, String maoyan_img, String maoyan_nm, String maoyan_dra, String maoyan_star, String maoyan_rt, String maoyan_sc, String maoyan_wish, String maoyan_vd) {
        this.maoyan_id = maoyan_id;
        this.maoyan_img = maoyan_img;
        this.maoyan_nm = maoyan_nm;
        this.maoyan_dra = maoyan_dra;
